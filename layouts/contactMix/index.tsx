  ...
  return (
    <FadeIn className="">
      <div className="mt-10 px-4 md:px-40 ">
        <div className="items-center justify-center gap-24 rounded-3xl bg-gradient-primary p-4 shadow-xl md:flex">
          <div className="flex flex-col gap-3 text-center">
            <p className="text-xl font-extrabold text-complement1 md:text-3xl">
              E aí, bora decolar <br />
              suas entregas?
            </p>
            <p className="text-center text-complement1 md:w-96">
              Venha fazer parte desse céu de oportunidades e inovações com a
              gente!
            </p>
            <p className="mt-8 flex items-center justify-center gap-2 text-center font-bold text-terciary">
